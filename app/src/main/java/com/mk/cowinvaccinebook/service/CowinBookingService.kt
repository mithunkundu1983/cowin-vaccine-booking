package com.mk.cowinvaccinebook.service
...
import com.mk.cowinvaccinebook.constant.AppConstant
import com.mk.cowinvaccinebook.data.model.ApiResult
import com.mk.cowinvaccinebook.data.model.BeneficiarySummary
import com.mk.cowinvaccinebook.data.model.Center
import com.mk.cowinvaccinebook.data.model.Session
import com.mk.cowinvaccinebook.repository.CowinAppRepository
import com.mk.cowinvaccinebook.usecase.*
import com.mk.cowinvaccinebook.usecase.model.*
import com.mk.cowinvaccinebook.view.activity.CowinBookingActivity
import com.mk.cowinvaccinebook.view.activity.MainActivity
...
private val sdf1: SimpleDateFormat = SimpleDateFormat("yyyy.MM.dd.HH.mm.ss")

@AndroidEntryPoint
class CowinBookingService: Service() {

    companion object {
        const val CHANNEL_ID = "com.mk.cowinvaccinebook.CowinBookingChannel"
        private const val NOTIFICATION_ID = 3455
        private const val WAKE_LOCK_TAG = "com.mk.cowinvaccinebook:WAKE_LOCK"
    }
    ...
    private fun filterAvailableCenters(
        ...
        val filteredCenters = centers?.filter { center ->
            ...
            val filteredSessions = center.sessions?.filter { session ->
                (session.availableCapacity_d2 ?: 0) >= beneficiaries.size &&
    ...
    private suspend fun publishStatus(message: String,
        ...
        if(publishToNotification) {
            ...
            publishableMessages.add("$timeStamp: $message")
