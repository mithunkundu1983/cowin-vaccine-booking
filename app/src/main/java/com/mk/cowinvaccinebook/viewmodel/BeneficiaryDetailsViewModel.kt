package com.mk.cowinvaccinebook.viewmodel
...
import com.mk.cowinvaccinebook.data.model.District
import com.mk.cowinvaccinebook.data.model.State
...
import com.mk.cowinvaccinebook.util.ResourceProvider
...
class BeneficiaryDetailsViewModel @Inject constructor(
    ...
    fun validateUserPref(
        ...
        if(refreshIntervalFinal < 1) {
            refreshIntervalFinal = 1
        ...
        if(_beneficiaries.value != null) {
            viewModelScope.launch {
                saveUserPreferenceUseCase.execute(
                    UserPreferenceAndBeneficiaries(
